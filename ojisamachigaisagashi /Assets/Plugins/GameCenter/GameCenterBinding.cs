...
public class GameCenterBinding
{
    ...
    {
		if( Application.platform == RuntimePlatform.IPhonePlayer )
			_gameCenterReportScore( score, 0, "jp.co.bonomu.bonomuScore" );
    }
	
	public static void reportScore( System.Int64 score, System.Int64 context, string leaderboardId )
    {
		if( Application.platform == RuntimePlatform.IPhonePlayer )
			_gameCenterReportScore( score, context, "jp.co.bonomu.bonomuScore" );
    }
    ...
    {
		if( Application.platform == RuntimePlatform.IPhonePlayer )
			_gameCenterIssueScoreChallenge( score, context, "jp.co.bonomu.bonomuScore", string.Join( ",", playerIds ), message );
    }
